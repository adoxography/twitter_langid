    ...
    with gzip.open(filename, 'rt') as f:
        for line in f:
            ...
            if model in ['word', 'tweet']:
                ...
                # include full tweet as single unicode string
                # (list of length 3)
...
class Dataset(object):
    ...
    def Prepare(self, in_vocab, out_vocab, und_label='und',
                ignore_categories=[]):
        ...
        if r > 0:
            n = batch_size - r
            self.AddDataSource(([list('{dummy}')] * n, [[und_label]] * n,
                               [0] * n), weight=0.0)
    ...
    def GetNextBatch(self):
        ...
        idx = list(range(self.current_idx,
